...
\begin{tikzpicture}
    ...
    \addplot[no marks, node style 1, line width=1.8pt] table [x index=0, y index=1] {data/nb_of_h2_beta0_h08.table};
    \addlegendentry{$\kappa^2$}

    \addplot[no marks, node style 2, line width=1.8pt] table [x index=0, y index=2] {data/nb_of_h2_beta0_h08.table};
    \addlegendentry{$\kappa^4$}

    \addplot[no marks, node style 3, line width=1.8pt] table [x index=0, y index=3] {data/nb_of_h2_beta0_h08.table};
    \addlegendentry{$\kappa^6$}

    \addplot[no marks, node style 4, line width=1.8pt] table [x index=0, y index=4] {data/nb_of_h2_beta0_h08.table};
