...
\begin{figure}
  \begin{center}
    \includegraphics[width=.65\textwidth]{nb_convergence_cluster_Z2}
  \end{center}
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=.65\textwidth]{nb_of_a_mu0999}
  \end{center} \vskip -.5cm
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[scale=1.65]{ladder_resummation_schematic}
  \end{center}
...
inversely proportional to $n$, the sum would result in a logarithm for instance.
The sum over $m$ might also prove beneficial.
