...
\begin{figure}
  \begin{center}
    \begin{adjustbox}{max width=\textwidth}
      \includegraphics{binding_energy_Z2_k2}
      \includegraphics{binding_energy_Z2_k8}
    \end{adjustbox}
...
\begin{figure}
  \begin{center}
    ...
    \includegraphics{a_of_beta_plot}
    \includegraphics{h2_of_a_plot}
    \end{adjustbox}
  \end{center}\vskip -.5cm
  ...
  \begin{center}
    ...
    \begin{tikzpicture}
      \node[inner sep=0pt] (fig1) {%
        \includegraphics[trim=0 0 0 .95cm, clip]{nb_of_a_Z2}%
      };
      \node[inner sep=0pt] [right=.2cm of fig1.north east,anchor=north west] {%
        \includegraphics{nb_continuum_Z2}%
      };
    \end{tikzpicture}
    \end{adjustbox}
...
\begin{figure}[t]
  {\centering
    \includegraphics[width=.5\textwidth]{cluster_number_of_terms}\par}
...
\begin{figure}
  \begin{center}
    \begin{adjustbox}{max width=\textwidth}
      \includegraphics{nb_of_h2_beta0}
      \includegraphics{nb_of_beta}
    \end{adjustbox}
  \end{center}\vskip -.6cm
...
\begin{figure}[t]
  {\centering
    \includegraphics[width=.65\textwidth]{nb_of_a_mu0999}\par}
...
\begin{figure}
  \begin{center}
    \begin{adjustbox}{max width=\textwidth}
      \includegraphics{nb_of_mpi_a02}
      \includegraphics{nb_of_mpi_a01}
    \end{adjustbox}
  \end{center}\vskip -.6cm
...
\begin{figure}
  \begin{center}
    \begin{adjustbox}{max width=\textwidth}
      \includegraphics{nb_of_h2_pade}
      \includegraphics{binding_energy_pade}
    \end{adjustbox}
  \end{center}\vskip -.6cm
...
Instead of the quark then hopping forth and directly back again, it will take a
...
somewhat trivial. The colour matrix content to enter the integrals is thus
%
\begin{equation}
...
\tikz \node[outer 2] {}; denotes a suitable \emph{graph remainder}. The sum over
all valid skeleton graphs is unfortunately an impossible task, and we will have
to restrict the analysis to a subset of the graphs we can compute. One such set
is all graphs where the chain never overlaps with itself, nor the graph
remainder. We can thus apply this resummation scheme to all embeddings and
combinations of graphs entering into the full $\mathcal{O}(\kappa^8)$ polymeric
linked cluster expansion. This includes direct map embeddings such as
%
\begin{equation}
...
\begin{figure}
  \begin{center}
    \begin{adjustbox}{max width=\textwidth}
      \includegraphics{resummed_nb_test_single_chain}
      \includegraphics{M_cumulants}
    \end{adjustbox}
  \end{center}\vskip -.6cm
