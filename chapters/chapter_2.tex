% TODO Check subscript f(F) for flavours (fundamental)
% TODO Check "space time", "spacetime", "space-time"
% TODO Add restrictions on the Yang Mills Lie group (semi-simple, compact?)
% TODO Consider specifying the gauge group earlier
