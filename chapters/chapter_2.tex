...
%
\begin{equation}
  \mathcal{S}_f = a^4 \bar{\psi}_y D_{yx} \psi_x, \hskip1em 
...
\begin{equation} \label{eq-fermion-integral}
  \int \prod_{i,j} \mathrm{d} \bar{\psi}_i \psi_j e^{\bar{\psi}_i D_{ij} \psi_j}
   = \det D,
\end{equation}
%
...
Having introduced the plaquette transporter in \meqref{eq-transport_plaquette},
