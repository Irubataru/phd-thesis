...
group characters as outlined in \apxref{sec-haar_measure}. For SU($3$) we
...
\begin{figure}
  {\centering
    \includegraphics[width=.49\textwidth]{convergence_numeric_kappa}
    \includegraphics[width=.49\textwidth]{convergence_numeric_beta}
    \par}
  \caption[
...
effective actions of increasing order in $\kappa$. One observes clearly how two
