...
It also possess non trivial topological structure, resulting in instanton
...
axis, one eventually pass into the quark-gluon-plasma state, a state in which
...
\emph{Columbia} plot, \figref{fig:phase_diags} (right). Although the point of
physical quark masses lie in the crossover area, whether a critical end-point
exist depends on whether the lower $Z(2)$ line shrinks or expands as one
increase chemical potential. It is also an open question whether this critical
line actually touch the chiral axis in the left or not
...
In \chapref{chap3} we follow this up by the necessary formalism to transition
