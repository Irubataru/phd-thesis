...
freedom are the bound states, baryons and mesons. Moving along the temperature
axis, one eventually passes into the quark-gluon-plasma phase, a phase in which
the thermodynamic energies are high enough that the quarks and gluons deconfine.
In this phase the quarks and gluons move around semi-freely, weakly interacting
