...
% TODO is the interval of t_E really compact?
...
\begin{equation}
  \phi(\tau_E + \beta) = \begin{cases}
    \hphantom{-}\phi(\tau_E), \hskip1em \text{for bosonic fields}, \\
    -\phi(\tau_E), \hskip1em \text{for fermionic fields}.
  \end{cases}
\end{equation}
...
\end{equation}
%
with either separate or degenerate $\mu_f$ for each fermion species. The isospin
charge is related to the Cartan generator of the flavour mixing SU$(2)$ symmetry
of a two flavour system (the third Pauli matrix)
%
\begin{equation}
